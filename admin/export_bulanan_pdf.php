...
$pdf->SetSubject('Laporan Data Keluarga Bulanan');
...
$pdf->Cell(0, 10, 'LAPORAN BULANAN DATA KELUARGA', 0, 1, 'C');
...
if ($bulan) $filterInfo .= "Bulan: " . date("F", mktime(0,0,0,$bulan,1)) . " | ";
...
$filename = 'Laporan_Bulanan_' . date('Y-m-d_His') . '.pdf';
